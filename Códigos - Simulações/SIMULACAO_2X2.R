...
### Tem que gerar dados da pragmática antes (usando códigos 01.TH_kx2_gerar_dados
### e 02.TH_kx2_resultados_dist)
...
dados <- tibble(x = c(57,185,153,57,267,459),
                y = c(435,245,111,44, 253, 463))
...
estima_propb_prag_hpd(k
                      ...
                      ,confianca
                      ,prior_par_list
                      ,dados_gerados_prag = dados_gerados %>% filter(prag)
                      ,m=c(m1,m2)
                      ,dados_full = dados
                      ,N = 1000
                      ,eps = 0.1)
...
# # A tibble: 6 × 4
# qui_quad fisher_test odds_lower1 odds_upper1
# <dbl>       <dbl>       <dbl>       <dbl>
#   1 1.10e-125   2.25e-141      0.0132      0.0281
# 2 1.64e-  4   1.61e-  4      0.475       0.787 
# 3 3.27e-  3   3.23e-  3      1.16        2.05  
# 4 2.08e-  1   2.08e-  1      0.881       2.02  
# 5 4.11e-  1   4.11e-  1      0.873       1.43  
# 6 7.24e-  1   7.24e-  1      0.563       1.42  
